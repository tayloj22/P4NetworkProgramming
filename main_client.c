...
void request_new_room(int sockfd) 
{
	...
	if (buffer[0] != 'F')
		...
		printf("All rooms are currently occupied. You will be given standard broadcasting.\n");
	printf("-------------------------------------------------\n");	
}
...
void join_particular_room(int sockfd, int room_number) 
{
	...
	if (buffer[0] != 'F') 
		...
		printf("That chat room was full. You will be given standard broadcasting.\n");
	printf("-------------------------------------------\n");	
}
...
void retrieve_chat_rooms(int sockfd) 
{
	...
	printf("-------------------------------------------\n");
	printf("This is the chatroom status.\n");
...
{
	sleep(.25);	// Wait for the server to catch up to client.
